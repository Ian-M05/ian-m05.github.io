    ...
    <div class="project-card fade-in-up">
      ...
      <div class="project-content">
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap;">
          <h3 style="margin: 0;">Fire Sprinkler Service</h3>
...
<section class="section bg-manilla">
  <div class="wrapper">
    ...
    <div class="skill-container" style="justify-content: center;">
      <span class="skill-tag"><i class="fas fa-gamepad"></i> Gaming</span>
      <span class="skill-tag"><i class="fas fa-desktop"></i> Building Computers</span>
      <span class="skill-tag"><i class="fas fa-futbol"></i> Soccer</span>
      <span class="skill-tag"><i class="fas fa-fist-raised"></i> Brazilian Jiu-Jitsu</span>
      <span class="skill-tag"><i class="fas fa-dumbbell"></i> Wrestling</span>
    </div>
